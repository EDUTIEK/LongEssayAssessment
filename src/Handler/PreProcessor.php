...
{
    /**
     * @param Closure(FileStream, Metadata): ?ProcessingStatus $fill
     */
    ...
    {
        $status = ($this->fill)($stream, $metadata);
        return $status === null ? new ProcessingStatus(ProcessingStatus::OK, 'idontcare') : $status;
    }
}
