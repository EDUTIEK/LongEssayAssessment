...
use ILIAS\Survey\Code\DataFactory;
...
class WriterAdmin2GUI extends BaseGUI implements DataTableParent, FilterParent
{
    ...
    public function getColumns(?array $additional_parameters) : array
    {
        ...
        $data_format = $data->dateFormat();
        $glyph = $this->uiFactory->symbol()->glyph();
        return [
            "image" => $tf->column()->text($this->lng->txt("image")),
            "name" => $tf->column()->text($this->lng->txt("name")),
            "pseudonym" => $tf->column()->text($this->plugin->txt("pseudonym")),
            "essay_status" => $tf->column()->status($this->plugin->txt("essay_status")),
            "time_extension" => $tf->column()->number($this->plugin->txt("writing_time_extension")),
            "last_save" => $tf->column()->date($this->plugin->txt("writing_last_save"), $data_format->standard()),
            "word_count" => $tf->column()->number($this->plugin->txt("word_count")),
            "location" => $tf->column()->text($this->plugin->txt("location")),
            "pdf" => $tf->column()->boolean($this->plugin->txt("pdf_version"), $this->lng->txt("yes"), $this->plugin->txt("no")),
        ];
    }

    public function getTotalRowCount(?array $filter_data, ?array $additional_parameters) : ?int
    {
        // TODO: Implement getTotalRowCount() method.
    }

    public function getTableActions() : array
    {
        // TODO: Implement getTableActions() method.
    }

    public function getTableItems(?array $ids = null, ?array $filter_data = null) : Generator
    {
        // TODO: Implement getTableItems() method.
    }

    public function getTableItem(int $id) : Item
    {
        // TODO: Implement getTableItem() method.
    }

    public function getFilterInputs() : array
    {
        // TODO: Implement getFilterInputs() method.
    }

    public function getFilterInputActivation() : ?array
    {
        // TODO: Implement getFilterInputActivation() method.
    }
}
