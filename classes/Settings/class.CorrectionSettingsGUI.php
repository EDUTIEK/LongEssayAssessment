...
class CorrectionSettingsGUI extends BaseGUI
{
    ...
    protected function editSettings()
    {
        ...
        if (!$orga_settings->getMultiTasks()) {
            ...
            $fields['mutual_visibility'] = $factory->checkbox($this->plugin->txt('mutual_visibility'),
        ...
        $fields['anonymize_correctors'] = $factory->checkbox(
            $this->plugin->txt('anonymize_correctors'), $this->plugin->txt('anonymize_correctors_info'))
        ...
        $fields['positive_rating'] = $factory->text($this->plugin->txt('comment_rating_positive'),
        ...
        $fields['negative_rating'] = $factory->text($this->plugin->txt('comment_rating_negative'),
        ...
        if (!$orga_settings->getMultiTasks()) {
            ...
            $fields['stitch_when_distance'] = $factory->optionalGroup(
                [
                    "max_auto_distance" => $factory->text($this->plugin->txt('max_auto_distance'),
